 ...
 * @throws {Parameter needs to be an instance of the Paper object.
 * @returns {void}
 */
 ...
 * @throws {The research requires a valid Function callback.
 * @returns {void}
 */
Researcher.prototype.addResearch = function( name, research ) {
	if ( isUndefined( name ) || isEmpty( name ) ) {
		throw  "Research name cannot be empty";
	}

	if ( ! ( research instanceof Function ) ) {
		throw  "The research requires a Function callback.";
	}
